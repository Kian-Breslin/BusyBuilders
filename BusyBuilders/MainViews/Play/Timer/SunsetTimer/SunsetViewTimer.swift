                ...
                HStack (spacing: 30){
                    ...
                    HStack (spacing: 5){
                        Image(systemName: "clock")
                            .foregroundStyle(textColor)
                        Text("\(timeFormattedSec(timerManager.timeElapsed))")
                            .bold()
                    }
                }
                .font(.system(size: 15))
...
#Preview {
    SunsetViewTimer(business: BusinessDataModel(businessName: "Kians Coffee Cafe", businessTheme: "red", businessType: "Eco-Friendly", businessIcon: "controller"), isTimerActive: .constant(true))

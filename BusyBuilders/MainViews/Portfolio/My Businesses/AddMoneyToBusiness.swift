...
struct AddMoneyToBusiness: View {
                ...
                HStack {
                    ...
                    Button("Add") {
                        if user.availableBalance >= Int(amount)!{
                            ...
                            print("Amount added to \(business.businessName): $\(money)")
                        }
                    }
...
#Preview {
    AddMoneyToBusiness(user: UserDataModel(username: "Keano517", name: "Kian Breslin", email: "Kianbreslin517@gmail.com"), business: BusinessDataModel(

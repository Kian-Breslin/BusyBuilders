    ...
    var body: some View {
        ...
        .fullScreenCover(isPresented: $isTimerActive) {
            if selectedBusiness != nil {
                Timer3(selectedBusiness: selectedBusiness!, setTime: timeSelected, isXPBoosterActive: isXPBoostOn, isCashBoosterActive: isCashBoosterOn, isCostReductionActive: isCostReductionOn, isTimerActive: $isTimerActive)
            } else {
                Text("Hello")
            }
        }
